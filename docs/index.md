...
`valid8` plays well with [autoclass](https://smarie.github.io/python-autoclass/): if you decorate a class constructor with validation, the property setters generated by `@autoclass` will include validation too. 
