...
# *************** Dependencies *********
INSTALL_REQUIRES = ['makefun', 'funcsigs;python_version<"3.3"', 'decopatch'] # 'typing_inspect' is now copied internally so as to be compliant with very old versions of typing module
DEPENDENCY_LINKS = []
